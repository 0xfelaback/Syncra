...
public class NodeStateConfiguration : IEntityTypeConfiguration<NodeState>
{
    public void Configure(EntityTypeBuilder<NodeState> builder)
    {
        ...
        builder.Property(n => n.Version).IsRowVersion().HasColumnName("version_control").IsConcurrencyToken();//.HasColumnType("xid").HasColumnName("xmin").IsConcurrencyToken().ValueGeneratedOnAddOrUpdate();
    }
}